...
import { Sparkles, Edit3, Eye, Wand2 } from "lucide-react";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {templates.map((tpl) => (
              <Card
                ...
                className="group relative flex flex-col justify-between aspect-[1.4] p-6 border-zinc-850 hover:border-brand-primary/40 overflow-hidden cursor-pointer bg-brand-surface/50"
              >
