      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            <Card variant="default" className="p-5 border-zinc-850 flex flex-col items-center justify-center text-center">
          ...
          <Card variant="default" className="p-6 border-zinc-850 space-y-4">
