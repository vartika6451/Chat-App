...
const Landing = ()=>{
    ...
    const [isWinking, setIsWinking] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Landing.useEffect": ()=>{
            const winkTimer = setTimeout({
                "Landing.useEffect.winkTimer": ()=>{
                    setIsWinking(true);
                }
            }["Landing.useEffect.winkTimer"], 1100);
            const introTimer = setTimeout({
                "Landing.useEffect.introTimer": ()=>{
                    setShowIntro(false);
                }
            }["Landing.useEffect.introTimer"], 3100);
            return ({
                "Landing.useEffect": ()=>{
...
_s(Landing, "1XZP+Tag2IfD7liQ4yZ7oioR41o=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
